...
const MediaRelationForm = ({ data, locale }: any) => {
  const { title } = data || {};
              ...
              {({
                ...
                <Form className="contactus-form-wrapper flex flex-col gap-[20px] lg:gap-[40px]">
                  <div className="flex flex-col justify-between gap-[19px] sm:flex-row lg:gap-[20px]">
                    <div className="flex w-full flex-col gap-[10px] sm:max-w-[400px]">
                      <label
                        htmlFor="fullName"
                    ...
                    <div
                      className={`flex w-full flex-col gap-[10px] sm:max-w-[400px] ${locale === "en" ? "react-tel-input-ar" : "react-tel-input-en"}`}
                    >
                      <label
                        htmlFor="phoneNumber"
                       className="font-DINAMedium forms-label font-medium rtl:font-TajawalMedium"
...
export default MediaRelationForm;
