...
function RespLocaleSwitcher(_a) {
    ...
    var setFontFamily = locale === "en" ? "font-GESndBookMedium" : "fontDINAMedium";
    return (React.createElement("div", { className: "lang-switch h-full flex items-center justify-center w-full" },
        React.createElement("button", { 
            // p-[8px]
            className: "lang-dropdown-select flex justify-center items-center cursor-pointer flex-row gap-[4px]  rounded-[6px] bg-transparent text-white ", style: { direction: "ltr" }, onClick: changeLang },
            React.createElement("span", { className: "font-medium text-[14px] leading-[14px] text-white uppercase " + setFontFamily }, switchText()),
            React.createElement("img", { src: "/assets/icons/chervon-left-white.svg", alt: "chevron", className: "" + imgCls }))));
}
exports["default"] = RespLocaleSwitcher;
